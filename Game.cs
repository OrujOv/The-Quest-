...
namespace The_Quest
{
    class Game
    {
        ...
        public bool ChekPlayerInventory(string weaponName)
        {
        ...
        public void IncreasePlatersHealth(int health, Random random)
        {
        ...
        {
            return new Point(boundaries.Left + random.Next(boundaries.Right / 10 - boundaries.Left/10)*10, //Is there any need to divide by 10?
